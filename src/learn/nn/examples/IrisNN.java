 ...
 * <p>
 * //visualstudiomagazine.com/Articles/2014/09/01/Azure-Machine-Learning-Studio.aspx
...
public class IrisNN extends MultiLayerFeedForwardNeuralNetwork {
    ...
    public static void main(String[] argv) throws IOException {
        ...
        List<Example> examples = new IrisExampleGenerator("learn/nn/examples/iris.data.txt").examples();
        ...
        File file = new File("nn_Iris.txt");
